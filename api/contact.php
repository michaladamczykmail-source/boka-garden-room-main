<?php
/**
 * Endpoint formularza kontaktowego BOKA TWO.
...
$model = cleanText((string) ($data['model'] ?? ''), 60);
...
$allowedModels = ['BOKA TWO', 'BOKA ONE', 'BOKA COMFORT', 'Sauna BOX', 'Sauna MODERN', 'Projekt na wymiar'];
...
try {
    ...
    $mail->Subject = 'Zapytanie ze strony BOKA Garden Room — ' . $model;
    $mail->isHTML(false);
    $mail->Body = implode("\n", [
